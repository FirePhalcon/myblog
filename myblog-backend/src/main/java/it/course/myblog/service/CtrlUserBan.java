...
public class CtrlUserBan {
	...
	public Optional<Blacklist> isBanned(Users user) {
		
		return blacklistRepository.findTopByBlacklistedUntilAfterAndUserOrderByBlacklistedUntil(LocalDate.now(), user);
	}
}
